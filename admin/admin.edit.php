     ...
     <div class="container-fluid bg-dark mb-5">
          <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
               <div class="container-fluid">
                    <a class="navbar-brand" href="admin-control.php">Admin dashboard</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                         <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                              ...
                              <li class="nav-item">
                                   <a href="invoice.php?updateId='<?= $id; ?>'" class="nav-link text-light">
                                        View Receipt
                                   </a>
                              </li>
                         </ul>
          ...
          <div class="container mt-5 pt-3">
               <form action="" method="post">
                    ...
                    <div class="mb-3">
                         ...
                         <input class="form-control" type="text" value="<?= $totalAmount ?>" name="amount" id="exampleFormControlTextarea1" required></input>
                    </div>
                    <div class="mb-3">
                         <label for="exampleFormControlTextarea1" class="form-label">Payment Method</label>
                         <input class="form-control" type="text" name="paymentMethod" value="<?= $paymentMethod ?>" name="paymentMethod" id="exampleFormControlTextarea1" required></input>
                    </div>
